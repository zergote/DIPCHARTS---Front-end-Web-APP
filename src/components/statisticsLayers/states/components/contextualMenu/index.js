...
const mapStateToProps = state => ({
  groupOptions: state.statisticsStates.groupOptions,
  selectedGroup: state.statisticsStates.selectedGroup,
  ...
  selectedRegion: state.statisticsStates.selectedRegion
})
