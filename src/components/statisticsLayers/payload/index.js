...
const mapStateToProps = state => {
  return {
    stateChartOptions: state.statisticsPayload.stateChartOptions,
    config: state.statisticsPayload.config,
    completeFetchData: state.statisticsPayload.completeFetchData,
    dropMenuShowSelectorLapse:
      state.statisticsPayload.dropMenuShowSelectorLapse,
    dropMenuShowSelectorService:
      state.statisticsPayload.dropMenuShowSelectorService,
    stateGroupOption: state.statisticsPayload.stateGroupOption,
    KPISELECTED:
      state.statisticsPayload.selectorChartOptions.column1.kpiSelected,
    ACTUALCONFIG: state.statisticsPayload.config,
    THEME: state.statisticsPayload.theme,
    IDREGION: state.statisticsPayload.selectedRegion.ID,
    IDSECTOR: state.statisticsPayload.selectedSector.ID,
    IDSERVICE: state.statisticsPayload.selectedService.ID,
    SINCETHEDATE: state.statisticsPayload.selectedTimeLapse.since,
    UNTILTHEDATE: state.statisticsPayload.selectedTimeLapse.until,
    REGION: state.statisticsPayload.selectedRegion.REGION,
    STATION: state.statisticsPayload.selectedStation.STATION,
    SECTOR: state.statisticsPayload.selectedSector.SECTOR,
    TYPECHART:
      state.statisticsPayload.selectorChartOptions.column1.typeChartSelected,
    IDGROUP: state.statisticsPayload.selectedGroup.ID,
    ADITIONALCHARTOPTIONS: state.statisticsPayload.selectorChartOptions,
    SERVICENAME: state.statisticsPayload.selectedService.SERVICE,
  }
}
