...
const mapStateToProps = state => ({
  selectorChartOptions: state.statisticsPayload.selectorChartOptions,
  stateChartOptions: state.statisticsPayload.stateChartOptions,
  selectedService: state.statisticsPayload.selectedService,
  services: state.statisticsPayload.services,
  showStation: state.statisticsPayload.showStation,
})
