...
const mapStateToProps = state => ({
  groupOptions: state.statisticsPayload.groupOptions,
  selectedGroup: state.statisticsPayload.selectedGroup,
  ...
  selectedRegion: state.statisticsPayload.selectedRegion
})
