...
class Highcharts extends Component {
  renderingToGraph(props) {
    ...
    switch (props.theme) {
      ...
      case 'dark-unica':
        // Load the fonts
        ReactHighcharts.Highcharts.createElement(
          'link',
          {
    ...
    HighchartsOffilineExporting(ReactHighcharts.Highcharts)
    ...
    HighchartsDataExporting(ReactHighcharts.Highcharts)
    ...
    ReactHighcharts.Highcharts.setOptions(ReactHighcharts.theme)
    ...
    if (props.completeFetchData === true) {
      ...
      return (
        ...
        >
          ...
          >
            <WaveLoading color="#ED164F" size="55" />
          </Div>
        </Div>
      )
    }
