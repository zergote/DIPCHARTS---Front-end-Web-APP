...
const mapStateToProps = state => ({
  groupOptions: state.statisticsMarkets.groupOptions,
  selectedGroup: state.statisticsMarkets.selectedGroup,
  ...
  selectedRegion: state.statisticsMarkets.selectedRegion
})
