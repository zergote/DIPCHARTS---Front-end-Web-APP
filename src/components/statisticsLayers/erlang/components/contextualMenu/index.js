...
const mapStateToProps = state => ({
  groupOptions: state.statisticsErlang.groupOptions,
  selectedGroup: state.statisticsErlang.selectedGroup,
  ...
  selectedRegion: state.statisticsErlang.selectedRegion
})
