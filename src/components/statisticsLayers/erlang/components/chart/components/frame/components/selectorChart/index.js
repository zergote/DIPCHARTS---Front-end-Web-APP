...
class SelectorChart extends Component {
  ...
  handleReset() {
    ...
    let originalConfig = {
      ...
      column1: {
        service: this.props.selectorChartOptions.column1.service,
        kpiSelected: ['ERLANG'],
        typeChartSelected: ['line', 'line'],
      },

      column2: {
        service: this.props.selectorChartOptions.column2.service,
        kpiSelected: [],
        typeChartSelected: ['line', 'line'],
      },

      column3: {
        service: this.props.selectorChartOptions.column3.service,
        kpiSelected: [],
        typeChartSelected: ['line', 'line'],
      },
    }
...
const mapStateToProps = state => ({
  selectorChartOptions: state.statisticsErlang.selectorChartOptions,
  stateChartOptions: state.statisticsErlang.stateChartOptions,
  selectedService: state.statisticsErlang.selectedService,
  services: state.statisticsErlang.services,
  showStation: state.statisticsErlang.showStation,
})
