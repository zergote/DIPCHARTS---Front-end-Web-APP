...
const mapStateToProps = state => ({
  groupOptions: state.statisticsClusters.groupOptions,
  selectedGroup: state.statisticsClusters.selectedGroup,
  ...
  selectedRegion: state.statisticsClusters.selectedRegion
})
