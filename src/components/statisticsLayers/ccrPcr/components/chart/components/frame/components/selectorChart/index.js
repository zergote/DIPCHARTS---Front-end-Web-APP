...
const mapStateToProps = state => ({
  selectorChartOptions: state.statisticsCcrPcr.selectorChartOptions,
  stateChartOptions: state.statisticsCcrPcr.stateChartOptions,
  selectedService: state.statisticsCcrPcr.selectedService,
  services: state.statisticsCcrPcr.services,
  showStation: state.statisticsCcrPcr.showStation,
})
