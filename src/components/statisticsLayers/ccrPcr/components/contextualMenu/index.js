...
const mapStateToProps = state => ({
  groupOptions: state.statisticsCcrPcr.groupOptions,
  selectedGroup: state.statisticsCcrPcr.selectedGroup,
  ...
  selectedRegion: state.statisticsCcrPcr.selectedRegion
})
