...
const mapStateToProps = state => {
  return {
    stateChartOptions: state.statisticsUsers.stateChartOptions,
    config: state.statisticsUsers.config,
    completeFetchData: state.statisticsUsers.completeFetchData,
    dropMenuShowSelectorLapse: state.statisticsUsers.dropMenuShowSelectorLapse,
    dropMenuShowSelectorService:
      state.statisticsUsers.dropMenuShowSelectorService,
    stateGroupOption: state.statisticsUsers.stateGroupOption,
    KPISELECTED: state.statisticsUsers.selectorChartOptions.column1.kpiSelected,
    ACTUALCONFIG: state.statisticsUsers.config,
    THEME: state.statisticsUsers.theme,
    IDREGION: state.statisticsUsers.selectedRegion.ID,
    IDSECTOR: state.statisticsUsers.selectedSector.ID,
    IDSERVICE: state.statisticsUsers.selectedService.ID,
    SINCETHEDATE: state.statisticsUsers.selectedTimeLapse.since,
    UNTILTHEDATE: state.statisticsUsers.selectedTimeLapse.until,
    REGION: state.statisticsUsers.selectedRegion.REGION,
    STATION: state.statisticsUsers.selectedStation.STATION,
    SECTOR: state.statisticsUsers.selectedSector.SECTOR,
    TYPECHART:
      state.statisticsUsers.selectorChartOptions.column1.typeChartSelected,
    IDGROUP: state.statisticsUsers.selectedGroup.ID,
    ADITIONALCHARTOPTIONS: state.statisticsUsers.selectorChartOptions,
    SERVICENAME: state.statisticsUsers.selectedService.SERVICE,
  }
}
