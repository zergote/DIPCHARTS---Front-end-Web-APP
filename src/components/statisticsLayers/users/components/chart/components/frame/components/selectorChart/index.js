...
class SelectorChart extends Component {
  ...
  handleOnChange(event) {
    ...
    let kpis = ['USERS_HSDPA', 'USERS_HSUPA']
  ...
  render() {
    //Traducir los nombres que son feos
              ...
              (kpiItem, i) => {
                return (
                  ...
                  >
                    ...
                    />
                    {this.props.selectorChartOptions.column1.service.SERVICE ===
                    '4G'
                ...
                return (
                  ...
                  >
                    <Input
                      ...
                      onChange={this.handleOnChange}
                    />
                    {this.props.selectorChartOptions.column2.service.SERVICE ===
                    '4G'
                      ? translateKpisName4G[kpiItem]
                      : translateKpisName3G[kpiItem]}
                  </Label>
                ...
                return (
                  ...
                  >
                    <Input
                      ...
                      onChange={this.handleOnChange}
                    />
                    {this.props.selectorChartOptions.column3.service.SERVICE ===
                    '4G'
                      ? translateKpisName4G[kpiItem]
                      : translateKpisName3G[kpiItem]}
                  </Label>
...
const mapStateToProps = state => ({
  selectorChartOptions: state.statisticsUsers.selectorChartOptions,
  stateChartOptions: state.statisticsUsers.stateChartOptions,
  selectedService: state.statisticsUsers.selectedService,
  services: state.statisticsUsers.services,
  showStation: state.statisticsUsers.showStation,
})
