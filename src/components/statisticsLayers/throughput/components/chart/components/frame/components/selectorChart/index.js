                    ...
                    css={{
                      display:
                        this.props.selectorChartOptions.column1.service
                          .SERVICE === '4G' && kpiItem === 'USERS_HSDPA'
                          ? 'none'
                          : 'block',
                      fontSize: '12px',
                      color: i === 0 ? '' : '#171717',
              ...
              (kpiItem, i) => {
                return (
                  <Label
                    css={{
                      display:
                        this.props.selectorChartOptions.column2.service
                          .SERVICE === '4G' && kpiItem === 'USERS_HSDPA'
                          ? 'none'
                          : 'block',
                      fontSize: '12px',
...
const mapStateToProps = state => ({
  selectorChartOptions: state.statisticsThroughput.selectorChartOptions,
  stateChartOptions: state.statisticsThroughput.stateChartOptions,
  selectedService: state.statisticsThroughput.selectedService,
  services: state.statisticsThroughput.services,
  showStation: state.statisticsThroughput.showStation,
})
