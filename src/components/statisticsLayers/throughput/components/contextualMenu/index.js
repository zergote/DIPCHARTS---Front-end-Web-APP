...
const mapStateToProps = state => ({
  groupOptions: state.statisticsThroughput.groupOptions,
  selectedGroup: state.statisticsThroughput.selectedGroup,
  ...
  selectedRegion: state.statisticsThroughput.selectedRegion
})
