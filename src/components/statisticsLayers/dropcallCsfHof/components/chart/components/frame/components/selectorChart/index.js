...
const mapStateToProps = state => ({
  selectorChartOptions: state.statisticsDropcallCsfHof.selectorChartOptions,
  stateChartOptions: state.statisticsDropcallCsfHof.stateChartOptions,
  selectedService: state.statisticsDropcallCsfHof.selectedService,
  services: state.statisticsDropcallCsfHof.services,
  showStation: state.statisticsDropcallCsfHof.showStation,
})
